// @author Dominika Bankiewicz & Aymeric Mislah
...
public class Test extends Application {
    ...
    private void saveTest(List<ConvexPolygon> ls, int maxX, int maxY, Stage myStage){
        ...
        // calcul de la couleur de chaque pixel, on passe par une instance de writableImage, 
        // qui possède une méthode pour obtenir un PixelReader.
